    ...
    R: Semigroup,
{
    ...
    where
        ...
        T::Batch: BatchReader<Key = K, Val = (), Time = S::Timestamp, R = R2> + 'static,
        T::Cursor: Cursor<Key = K, Val = (), Time = S::Timestamp, R = R2> + 'static;
...
where
    ...
    T1::Batch: BatchReader<Key = K, Val = V, Time = S::Timestamp, R = R> + 'static,
    T1::Cursor: Cursor<Key = K, Val = V, Time = S::Timestamp, R = R> + 'static,
{
    fn semijoin_arranged<R2, T>(
        &self,
        other: &Arranged<S, T>,
