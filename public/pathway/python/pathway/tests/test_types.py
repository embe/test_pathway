...
def test_date_time_naive_schema():
    ...
    assert repr(schema["t1"]) == "<class 'pathway.internals.types.DateTimeNaive'>"
    assert repr(schema["t2"]) == "<class 'pathway.internals.types.DateTimeNaive'>"
    assert repr(schema["diff"]) == "<class 'pathway.internals.types.Duration'>"
...
def test_date_time_utc_schema():
    ...
    schema = table_with_datetimes.schema.as_dict()
    assert repr(schema["t1"]) == "<class 'pathway.internals.types.DateTimeUtc'>"
    assert repr(schema["t2"]) == "<class 'pathway.internals.types.DateTimeUtc'>"
    assert repr(schema["diff"]) == "<class 'pathway.internals.types.Duration'>"
