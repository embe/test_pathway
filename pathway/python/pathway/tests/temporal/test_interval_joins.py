...
from pathway.internals.types import DateTimeNaive, DateTimeUtc
...
def test_incorrect_args_specific():
 ...
 <class 'float'>) or (<class 'pathway.internals.types.DateTimeNaive'>,
 <class 'pathway.internals.types.DateTimeNaive'>, <class 'pathway.internals.types.Duration'>,
 <class 'pathway.internals.types.Duration'>) or (<class 'pathway.internals.types.DateTimeUtc'>,
 <class 'pathway.internals.types.DateTimeUtc'>, <class 'pathway.internals.types.Duration'>,
 <class 'pathway.internals.types.Duration'>) but are of types
 (<class 'pathway.internals.types.DateTimeNaive'>, <class 'int'>, <class 'int'>, <class 'int'>).""".replace(
        "\n", ""
    )
