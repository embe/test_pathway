...
def stream_linear_regression_example(
    ...
    >>> table = pw.demo.stream_linear_regression_example(nb_rows=100, input_rate=2.0)
    ...
    if nb_rows < 0:
        raise ValueError(
            "demo.stream_linear_regression_example error: nb_rows should be strictly positive."
        )
    import random
...
def stream_sum_example(
    ...
    >>> table = pw.demo.stream_sum_example(nb_rows=50, offset=10, input_rate=2.5)
    ...
    if nb_rows < 0:
        raise ValueError(
            "demo.stream_sum_example error: nb_rows should be strictly positive."
        )
