...
def declare_type(
    target_type, col: expr.ColumnExpressionOrConst
...
def cast(target_type: Any, col: expr.ColumnExpressionOrConst) -> expr.CastExpression:
...
@runtime_type_check
@trace_user_frame
def coalesce(*args: expr.ColumnExpressionOrConst) -> expr.ColumnExpression:
...
@runtime_type_check
@trace_user_frame
def require(val, *deps: expr.ColumnExpressionOrConst) -> expr.ColumnExpression:
...
@trace_user_frame
def if_else(
    if_clause: expr.ColumnExpressionOrConst,
    then_clause: expr.ColumnExpressionOrConst,
    else_clause: expr.ColumnExpressionOrConst,
) -> expr.ColumnExpression:
    """Equivalent to::
...
@runtime_type_check
@trace_user_frame
def make_tuple(*args: expr.ColumnExpressionOrConst) -> expr.ColumnExpression:
    """
